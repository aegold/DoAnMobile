...
router.post('/create_payment_url', function (req, res, next) {
    ...
    vnp_Params['vnp_OrderInfo'] = req.body.orderInfo;
    vnp_Params['vnp_OrderType'] = req.body.orderType;
...
router.get('/vnpay_return', function (req, res, next) {
    try {
        ...
        // Trả về trang HTML đơn giản với hướng dẫn rõ ràng cho mobile
        res.send(`
            <html>
                <head>
...
router.get('/check-status/:orderId', async function (req, res) {
    // Luôn trả về thành công
